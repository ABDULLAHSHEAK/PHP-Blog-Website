...
$sql = "SELECT * FROM post LEFT JOIN users ON post.auth_id = users.role WHERE auth_id = '$auth_id' limit $offset,$limit ";
...
<div class="container mt-4 mb-4">
  <div class="row">
    ...
    line-height: 50vh;'>No Post Found</h4>";
      ...
      <?php
      $pagination = "SELECT * FROM post WHERE auth_id = '$auth_id'";
