...
$alert = '';
if (isset($_POST["save"])) {
  $policy_des = mysqli_real_escape_string($con, $_POST["contact"]);
  $query = "UPDATE pages SET contact = '$policy_des'";
  $run = mysqli_query($con, $query);
  if ($run) {
...
<div class="col-lg-10 col-md-10">
  ...
  <div class="card shadow">
    <div class="card-header py-3 d-flex justify-content-between">
      <div>
        <h6 class="mt-2">Edit Contact Page</h6>
      </div>
      <div>
    ...
    <div class="card-body">
      <form action="" method="POST" enctype="multipart/form-data">
        Post Description
        <textarea name="contact" id="post_description" cols="30" rows="6" class="form-control"><?= $body ?></textarea> <br>
